package btree.bbbb;//Program to Implement Insertion in B-Trees

import tree.TreePrinter;


public class BTreebbbb {
	//Node class
	static class Node implements TreePrinter.PrintableNode{
		...
		@Override
		public TreePrinter.PrintableNode getRight() { return children[1];}
	...
	static int t = 2;		//value of parameter t.
